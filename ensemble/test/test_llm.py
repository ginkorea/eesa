...
if __name__ == "__main__":
    ...
    test_texts = [
        "This is one of the best products I've ever used. Highly recommend it!",
        ...
        "I absolutely love this! It exceeded my expectations.",
        "I was disappointed with the quality. It didn't meet my standards.",
        "The product is decent, but I've seen better options out there.",
        "I can't believe how bad this was. I expected so much more.",
        "The best product I have purchased from Trump. If only it could make him just go away.",
        "Trump",
    ]

    for text in test_texts:
        print(f"\n🔍 Processing: {text}")
        result = label_row(text, verbose=True)
